defmodule OfflineInfoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OfflineInfoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OfflineInfoWeb.Gettext, "errors", msg, opts)
    end
  end
